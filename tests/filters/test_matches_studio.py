...
class TestMatchesStudio:
    def test_matches_studio_with_name(self):
    ...
    def test_matches_studio_with_no_match(self):
    ...
    def test_scene_with_no_studio(self):
